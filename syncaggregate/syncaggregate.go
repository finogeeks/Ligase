...
func SetupSyncAggregateComponent(
	...
	if base.Cfg.Rpc.Driver == "grpc_with_consul" {
		...
		consulTag := base.Cfg.Rpc.SyncAggregate.ConsulTagPrefix + strconv.Itoa(int(base.Cfg.MultiInstance.Instance))
		c := consul.NewConsul(base.Cfg.Rpc.ConsulURL, consulTag, base.Cfg.Rpc.SyncAggregate.ServerName, base.Cfg.Rpc.SyncAggregate.Port)
		c.Init()
	}
