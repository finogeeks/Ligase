...
func ToEventBuilder(b *pb.EventBuilder) *gomatrixserverlib.EventBuilder {
	stateKey := (*string)(nil)
	if b.StateKeyExists {
		stateKey = &b.StateKey
	}
	return &gomatrixserverlib.EventBuilder{
		Sender:        b.Sender,
		RoomID:        b.RoomID,
		Type:          b.Type,
		StateKey:      stateKey,
		Redacts:       b.Redacts,
		Depth:         b.Depth,
		DomainOffset:  b.DomainOffset,
		Content:       b.Content,
		Unsigned:      b.Unsigned,
		RedactsSender: b.RedactsSender,
	}
}

func ToPBEventBuilder(b *gomatrixserverlib.EventBuilder) *pb.EventBuilder {
	stateKey := ""
	exists := false
	if b.StateKey != nil {
		stateKey = *b.StateKey
	...
	return &pb.EventBuilder{
		Sender:         b.Sender,
		RoomID:         b.RoomID,
		Type:           b.Type,
		StateKey:       stateKey,
		StateKeyExists: exists,
		Redacts:        b.Redacts,
		Depth:          b.Depth,
		DomainOffset:   b.DomainOffset,
		Content:        b.Content,
